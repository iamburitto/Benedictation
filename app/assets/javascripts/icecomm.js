(function e(t, n, r) {
    ...
    4: [
        ...
        function(require, module, exports) {
            ...
            function createDataChannel(callerID, localPeerConnections) {
                ...
                dataChannels[callerID].channel = localPeerConnections[callerID].channel.createDataChannel('RTCDataChannel', {
                    reliable: true
                });
            }
        ...
        function(require, module, exports) {
            ...
            var Icecomm = function(APIKEY, appSettings) {
                ...
                this.send = function(data, callerID) {
                    utils.printDebugMessage('this.send callerid: ', callerID);
            ...
            "./EventEmitter": 1,
            "./browserHandler": 3,
            "./dataChannelHandler": 4,
            "./domainHandler": 5,
            "./peerConnectionHandler": 8,
            "./roomHandler": 9,
            "./socketHandler": 11,
            "./streamHandler": 12,
            "./utils": 13
    ...
    8: [
        ...
        function(require, module, exports) {
            ...
            function send(callerID, data) {
                console.log('In send method, localPeerConnections: ', localPeerConnections);
                data = JSON.stringify(data);
                // if sending to everyone in the room
    ...
    13: [
        ...
        function(require, module, exports) {
            ...
            function parseSDP(sdp) {
                ...
                var invalidLineIndex = sdpLines.indexOf('a=fmtp:0 profile-level-id=0x42e00c;packetization-mode=1');
